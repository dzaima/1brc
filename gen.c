...
l17:;
  ...
  __m256i v216 = v215_nums;
  __m256i v217 = _mm256_set1_epi64x(((int64_t)0x00ffffffffffffffll));
  __m256i v218 = _mm256_and_si256(v216, v217);
  v215_nums = v218;
  __m256i v219 = _mm256_set1_epi8(((int8_t)46ll));
  __m256i v220 = _mm256_cmpeq_epi8(v219, v215_nums);
  __m256i v221 = v220;
  __m256i v222 = _mm256_srai_epi32(v221, 23);
  __m256i v223 = v222;
  __m256i v224 = v223;
  __m256i v225 = v224;
  __m256i v226 = _mm256_set1_epi64x(((int64_t)3ll));
  ...
  __m256i v231_aligned = _mm256_shuffle_epi8(v215_nums, v228_off);
  ...
  __m256i v243 = _mm256_cmpeq_epi8(v242, v215_nums);
  __m256i v244 = v243;
  __m256i v245 = _mm256_set1_epi16(((int16_t)0ll));
  __m256i v246 = _mm256_cmpeq_epi16(v244, v245);
  uint16_t v247 = ~(((uint16_t)0ull));
  int16_t v248 = (int16_t)v247;
  __m256i v249 = _mm256_set1_epi16(v248);
  __m256i v250 = v249;
  __m256i v251_neg = _mm256_xor_si256(v246, v250);
  __m256i v252 = v251_neg;
  v241_each16 = _mm256_xor_si256(v241_each16, v252);
  __m256i v253 = v251_neg;
  v241_each16 = _mm256_sub_epi16(v241_each16, v253);
  int16_t* v254 = v195_buf + ((int64_t)0ll);
  __m256i* v255 = (__m256i*)v254;
  __m256i* v256 = v255 + ((int64_t)0ll);
  _mm256_storeu_si256(v256, v241_each16);
...
l26:;
  ...
  uint64_t v391 = v381_dataoff + ((uint64_t)3ull);
...
l27:;
  ...
  int32_t v396 = v5_map_data[v381_dataoff];
  int32_t v397 = v396 + v384_temp;
  v5_map_data[v381_dataoff] = v397;
  uint64_t v399 = v381_dataoff + ((uint64_t)1ull);
  int32_t v400 = v5_map_data[v399];
  int32_t v401 = v400 + ((int32_t)1ll);
  v5_map_data[v399] = v401;
l25:;
  uint64_t v403 = v261 + ((uint64_t)1ull);
  bool v404 = v403 >= v258;
  bool v405 = __builtin_expect(v404, 0);
  if (!(v405)) goto l28;
  goto l16;
l28:;
  uint64_t v406 = v333_idxs * ((uint64_t)16ull);
  int8_t* v407 = v3_map_exp + v406;
  __m128i* v408 = (__m128i*)v407;
  __m128i* v409 = v408 + ((int64_t)0ll);
  __m128i v410_exp = _mm_loadu_si128(v409);
  __m128i v411 = _mm_cmpeq_epi8(v307, v410_exp);
  uint16_t v412 = _mm_movemask_epi8(v411);
  bool v413 = v412 == ((uint16_t)65535ull);
  bool v414 = !(v413);
  if (!(v414)) goto l29;
  uint64_t v415 = v200_off + v403;
  uint64_t v416 = v1_buf0[v415];
  v1_buf0[v13_off] = v416;
  uint64_t v418 = v403 * ((uint64_t)4ull);
  int16_t v419 = v195_buf[v418];
  uint64_t v420 = (uint64_t)v419;
  uint64_t v421 = v13_off + ((uint64_t)1ull);
  v1_buf0[v421] = v420;
  v13_off = v13_off + ((uint64_t)2ull);
  goto l30;
l29:;
  uint64_t v423_dataoff = v333_idxs * ((uint64_t)4ull);
  uint64_t v424 = v403 * ((uint64_t)4ull);
  int16_t v425 = v195_buf[v424];
  int32_t v426_temp = (int32_t)v425;
  uint64_t v427 = v423_dataoff + ((uint64_t)2ull);
  int32_t v428 = v5_map_data[v427];
  int32_t v429 = -(v426_temp);
  bool v430 = v428 > v429;
  int32_t v431_r = v429;
  if (!(v430)) goto l31;
  v431_r = v428;
l31:;
  v5_map_data[v427] = v431_r;
  uint64_t v433 = v423_dataoff + ((uint64_t)3ull);
  int32_t v434 = v5_map_data[v433];
  bool v435 = v434 > v426_temp;
  int32_t v436_r = v426_temp;
  if (!(v435)) goto l32;
  v436_r = v434;
l32:;
  v5_map_data[v433] = v436_r;
  int32_t v438 = v5_map_data[v423_dataoff];
  int32_t v439 = v438 + v426_temp;
  v5_map_data[v423_dataoff] = v439;
  uint64_t v441 = v423_dataoff + ((uint64_t)1ull);
  int32_t v442 = v5_map_data[v441];
  int32_t v443 = v442 + ((int32_t)1ll);
...
l15:;
l33:;
  bool v445 = v12_off < v13_off;
  if (!(v445)) goto l34;
  uint64_t v446 = v1_buf0[v12_off];
  uint64_t v447 = v12_off + ((uint64_t)1ull);
  uint64_t v448 = v1_buf0[v447];
  int64_t v449 = (int64_t)v448;
  v12_off = v12_off + ((uint64_t)2ull);
  uint64_t v450 = v446 - ((uint64_t)16ull);
  int8_t* v451 = v6_inp + v450;
  __m128i* v452 = (__m128i*)v451;
  __m128i* v453 = v452 + ((int64_t)0ll);
  __m128i v454 = _mm_loadu_si128(v453);
  __m128i v455 = _mm_set1_epi8(((int8_t)10ll));
  __m128i v456 = _mm_cmpeq_epi8(v455, v454);
  uint16_t v457_m = _mm_movemask_epi8(v456);
  bool v458 = v457_m == ((uint16_t)0ull);
  bool v459 = __builtin_expect(v458, 1);
  if (!(v459)) goto l35;
  uint64_t v460_start = v446;
l36:;
  v460_start = v460_start - ((uint64_t)16ull);
  uint64_t v461 = v460_start - ((uint64_t)16ull);
  int8_t* v462 = v6_inp + v461;
  __m128i* v463 = (__m128i*)v462;
  __m128i* v464 = v463 + ((int64_t)0ll);
  __m128i v465 = _mm_loadu_si128(v464);
  __m128i v466 = _mm_set1_epi8(((int8_t)10ll));
  __m128i v467 = _mm_cmpeq_epi8(v466, v465);
  v457_m = _mm_movemask_epi8(v467);
  bool v468 = v457_m == ((uint16_t)0ull);
  if (v468) goto l36;
  uint32_t v469 = (uint32_t)v457_m;
  uint64_t v470 = __builtin_clz(v469);
  uint64_t v471 = v470 - ((uint64_t)16ull);
  uint64_t v472 = v460_start - v471;
  failed_long(v472, v446, v449);
  goto l37;
l35:;
  uint32_t v474 = (uint32_t)v457_m;
  uint64_t v475 = __builtin_clz(v474);
  uint64_t v476_c = v475 - ((uint64_t)16ull);
  uint64_t v477 = v446 - v476_c;
  int8_t* v478 = v196_buf + v476_c;
  __m128i* v479 = (__m128i*)v478;
  __m128i* v480 = v479 + ((int64_t)0ll);
  __m128i v481 = _mm_loadu_si128(v480);
  __m128i v482 = _mm_and_si128(v454, v481);
  __m128i v483_hv = v482;
  __m128i v484 = _mm_shuffle_epi32(v483_hv, 238);
  v483_hv = _mm_xor_si128(v483_hv, v484);
  __m128i v485 = v483_hv;
  __m128i v486 = _mm_srli_epi64(v485, 32);
  __m128i v487 = v486;
  v483_hv = _mm_xor_si128(v483_hv, v487);
  __m128i v488 = v483_hv;
  __m128i v489 = _mm_srai_epi32(v488, 16);
  __m128i v490 = v489;
  v483_hv = _mm_xor_si128(v483_hv, v490);
  __m128i v491 = v483_hv;
  int32_t v492 = _mm_extract_epi32(v491, 0);
  uint32_t v493 = (uint32_t)v492;
  failed_short(v477, v446, v449, v493);
l37:;
  goto l33;
l34:;
}
